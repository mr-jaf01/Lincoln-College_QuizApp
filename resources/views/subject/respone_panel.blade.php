         ...
         <div class="card-header" style="border-radius: 19px;">
             ...
             <ul class="d-flex flex-row justify-content-around nav nav-tabs" id="myTab" role="tablist">
                 <li class="nav-item" role="presentation">
                     <a class="nav-link active link-danger d-flex flex-column align-items-center" id="quiz-tab" data-toggle="tab" href="#quiz" role="tab" aria-controls="quiz" aria-selected="false"><i class="bi bi-question-circle"></i>Quiz</a>
                 </li>
                 <li class="nav-item" role="presentation">
                    <a class="nav-link link-danger d-flex flex-column align-items-center" id="video-tab" data-toggle="tab" href="#video" role="tab" aria-controls="video" aria-selected="true"><i class="bi bi-collection-play"></i>Video </a>
                </li>
             </ul>
         </div>
         <div class="card-body">
                     ...
                     <div class="row">
                         <div class="col-md-3 mb-2">
                             <div class="card">
                                 ...
                                 <div class="card-body">
                                     <span class="font-weight-bold">{{ $subject }} - <small class="font-bold">{{ Str::upper($qmode) }} - </small><small>{{ $year }}</small></span>
                                 </div>
                               </div>
                         </div>
                         <div class="col-md-9">
                             ...
                             <div class="row justify-content-around d-flex mt-3 mb-3">
                                 <a style="border-radius:19px;" href="/dashboard/quiz/{{$subject}}/{{$year}}/{{$qmode}}" class="group relative w-full  flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                     Start Quiz
                                 </a>
                             </div>
                         </div>
